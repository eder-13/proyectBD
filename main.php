    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p><a class="btn btn-secondary" href="first.php" role="button">Make Query &raquo;</a></p>
        </div>

        <div class="col-md-4">
          <h2>Query #2</h2>
          <p>This query returns the workers with delays in a given date range.</p>
          <p><a class="btn btn-secondary" href="second_form.php" role="button">Make Query &raquo;</a></p>
        </div>

        <div class="col-md-4">
          <h2>Query #3</h2>
          <p>This query returns the workers with accumulated minutes by area.</p>
          <p><a class="btn btn-secondary" href="third_form.php" role="button">Make Query &raquo;</a></p>
        </div>
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p><a class="btn btn-secondary" href="fourth_form.php" role="button">Make Query &raquo;</a></p>
        </div>

        <div class="col-md-4">
          <h2>Query #5</h2>
          <p>This query returns all the sundays and hollydays of the year.</p>
          <p><a class="btn btn-secondary" href="fifth.php" role="button">Make Query &raquo;</a></p>
        </div>

        <div class="col-md-4">
          <h2>Query #6</h2>
          <p>This query returns the payment to the workers' bank.</p>
          <p><a class="btn btn-secondary" href="sixth.php" role="button">Make Query &raquo;</a></p>
        </div>
        
        <div class="col-md-4">
          <h2>Query #7</h2>
          <p>This query returns the historical payments to the workers in a given date range.</p>
          <p><a class="btn btn-secondary" href="seventh_form.php" role="button">Make Query &raquo;</a></p>
        </div>
        
        <div class="col-md-4">
          <h2>Query #8</h2>
          <p>This query returns the payment made for every cost center.</p>
          <p><a class="btn btn-secondary" href="eighth.php" role="button">Make Query &raquo;</a></p>
        </div>
      </div>
